...
public class ProductController {
	 ...
	 * MediaType.APPLICATION_JSON_VALUE) public ResponseEntity<ProductDTO>
	 * getProductv4(@PathVariable Integer id) { Product p =
	 * productService.getProductById(id); if (p != null) { ProductDTO pdto =
	 * productService.applyDiscountV4(p); return new
	 * ResponseEntity<ProductDTO>(pdto, HttpStatus.FOUND); } else { return new
